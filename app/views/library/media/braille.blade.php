...
@stop
@section('body')
<div class="container" ng-controller="MediaDetailEditController" ng-init="InitMediaType('braille')">
  <div ng-class="panelclass">
    <div class="panel-heading text-center" class="panel-title">
      <span style="font-size: 20px;color:white">
         <u><strong>เบลล์<span ng-show="media.master == 1">ต้นฉบับ.</span></strong></u> 
         <% media.id %><span ng-hide="media.original_no == null">(<%media.original_no%>)</span> :: <% book.title %>
         <span ng-show="media.reserved == 0">(ยืมได้)</span>
         <span ng-show="media.reserved == 1">(ถูกยืม)</span>
        ...
        <div class="col-md-12">
          <table class="table text-center">
            ...
            <tr ng-repeat = "detail in details">
              ...
              <td>
                <select class="form-control" ng-options="st as st.label for st in status track by st.id" ng-model="selected_status[$index]" 
