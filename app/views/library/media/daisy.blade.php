...
@stop
@section('body')
<div class="container" ng-controller="MediaDetailEditController" ng-init="InitMediaType('daisy')">
  <div ng-class="panelclass">
    <div class="panel-heading text-center" class="panel-title">
      <span style="font-size: 20px;color:white">
         <u><strong>เดซี่<span ng-show="media.master == 1">ต้นฉบับ.</span></strong></u> 
