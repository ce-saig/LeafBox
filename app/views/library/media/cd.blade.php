...
@stop
@section('body')
<div class="container" ng-controller="MediaDetailEditController" ng-init="InitMediaType('cd')">
  <div ng-class="panelclass">
    <div class="panel-heading text-center" class="panel-title">
      <span style="font-size: 20px;color:white">
         <u><strong>ซีดี<span ng-show="media.master == 1">ต้นฉบับ.</span></strong></u> 
        ...
        <div class="col-md-12">
          <table class="table text-center">
            ...
            <tr ng-repeat = "detail in details">
              ...
              ng-init="selected_status[$index] = status[detail.status]" ng-change="SelectStatus($index)" ng-disabled="media.reserved==1"></select></td>
