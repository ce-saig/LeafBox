		  ...
		  <div class="col-lg-4" style="margin-top: 10px" ng-repeat="prod in prods.label">  
		    <div class="input-group">
		      <span class="input-group-addon" style="font-size: 16px">
		        <input type="checkbox" ng-model="prods.enabled[$index]"> สถานะการผลิต<%prod%>
		      </span>
		      <select class="form-control" ng-options = "idx as item for (idx, item) in BookProductionService.status[$index]" ng-model="prods.model[$index]" ng-show="prods.enabled[$index]" style="height: 32px">
    		  </select>
		    </div><!-- /input-group -->
		  </div><!-- /.col-lg-3 -->
		</div>
  	...
  	<div class="container" style="margin-top: 20px">
		...
		<div class = "container">
		  <div class="col-lg-3" style="margin-top: 10px" ng-repeat="prod in prods.label">  
		    <div class="input-group">
		      <span class="input-group-addon" style="font-size: 16px">
		        <input type="checkbox" ng-model="medias.enabled[$index]"> <%prod%>
		      </span>
