<div class="container" style="width:auto" ng-controller="BookViewController">
	...
	<div class="col-xs-6 col-sm-4">{{($book['regis_date'] == "" || $book['regis_date'] == null) ? '-' : substr($book['regis_date'],0,10)}}</div>
	...
	<div class="col-xs-6 col-sm-2">{{($product['product_b'] == null)? '-' :substr($product['product_b']->finish_date, 0,10)}}</div>
	...
	<div class="col-xs-6 col-sm-2"><b>เมื่อ</b></div>
	<div class="col-xs-6 col-sm-2">{{($product['product_c'] == null)? '-' :substr($product['product_c']->finish_date, 0,10)}}</div>
	...
	<div class="col-xs-6 col-sm-2"><b>เมื่อ</b></div>
	<div class="col-xs-6 col-sm-2">{{($product['product_d'] == null)? '-' :substr($product['product_d']->finish_date, 0,10)}}</div>
	...
	<div class="col-xs-6 col-sm-2"><b>เมื่อ</b></div>
	<div class="col-xs-6 col-sm-2">{{($product['product_cd'] == null)? '-' :substr($product['product_cd']->finish_date, 0,10)}}</div>
	...
	<div class="col-xs-6 col-sm-2"><b>เมื่อ</b></div>
	<div class="col-xs-6 col-sm-2">{{($product['product_dvd'] == null)? '-' : substr($product['product_dvd']->finish_date, 0,10)}}</div>
