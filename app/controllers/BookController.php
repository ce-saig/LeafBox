...
class BookController extends Controller{
  ...
  public function getBook($bid){
    ...
    $field[32]='หมายเหตุ';
    $field[33]='เมื่อ';
    $field[34]='เบลล์ต้นฉบับ';
    $field[35]='คาสเซ็ทต้นฉบับ';
    $field[36]='CDต้นฉบับ';
    $field[37]='เดซี่ต้นฉบับ';
    $field[38]='DVDต้นฉบับ';
  ...
  public function getEdit($bid){
    ...
    $label[15]='เมื่อ';
    $field[15]='bm_date';
    $field[17]='เบลล์ต้นฉบับ';
    $label[17]='bm_no';

    $label[18]='สถานะของคาสเส็ท';
    $field[18]='cs_status';
    $label[20]='หมายเหตุ';
    $field[20]='cs_note';
    $label[19]='เมื่อ';
    $field[19]='cs_date';
    $field[21]='คาสเซ็ทต้นฉบับ';
    $label[21]='cm_no';

    $label[22]='สถานะของเดซี่';
    $field[22]='ds_status';
    $label[24]='หมายเหตุ';
    $field[24]='ds_note';
    $label[23]='เมื่อ';
    $field[23]='ds_date';
    $field[25]='เดซี่ต้นฉบับ';
    $field[25]='dm_no';

    $label[26]='สถานะของซีดี';
    $field[26]='cd_status';
    $label[28]='หมายเหตุ';
    $field[28]='cd_note';
    $label[27]='เมื่อ';
